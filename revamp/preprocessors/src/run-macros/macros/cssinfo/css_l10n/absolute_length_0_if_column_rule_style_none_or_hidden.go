...
func absoluteLength0IfColumnRuleStyleNoneOrHidden(env *environment.Environment, reg *registry.Registry, _ string, _ string) (string, error) {
	...
	ref, err := cssxref.Cssxref(env, reg, "column-rule-style")
	if err != nil {
		return "", err
	}
