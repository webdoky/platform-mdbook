...
func absoluteLengthOr0IfBorderRightStyleNoneOrHidden(env *environment.Environment, reg *registry.Registry, _ string, _ string) (string, error) {
	...
	ref, err := cssxref.Cssxref(env, reg, "border-right-style")
	if err != nil {
		return "", err
	}
