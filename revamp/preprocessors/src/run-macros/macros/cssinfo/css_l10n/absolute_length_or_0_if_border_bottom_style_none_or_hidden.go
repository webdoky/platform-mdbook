...
func absoluteLengthOr0IfBorderBottomStyleNoneOrHidden(env *environment.Environment, reg *registry.Registry, _ string, _ string) (string, error) {
	...
	ref, err := cssxref.Cssxref(env, reg, "border-bottom-style")
	if err != nil {
		return "", err
	}
